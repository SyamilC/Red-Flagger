# Dating Profile Audit Report — Profile Absolute Green

**Overall result:** Low-to-Moderate risk (36.51/100).
...
- **substance_risk** — Heavy drinking, smoking, drugs, or party-heavy lifestyle. Max probability: 0.5168; mean ensemble probability: 0.3047. Sources: nlp, transformer.

## 2. Tabular/profile metadata signals
- The tabular SMOTE model did not independently trigger any metadata flag.
...
- Text risk from strongest labels: 0.4868.
